...
internal static unsafe class RapierBindings
{
	...
	public static void SetRigidBodyDrag(RigidBodyHandle rbHandle, float linearDrag, float angularDrag) => ((delegate* unmanaged[Cdecl]<RigidBodyHandle, float, float, void>) data.Data.setRigidBodyDrag)(rbHandle, linearDrag, angularDrag);
	...
	[DllImport(DllName, CallingConvention = Convention, EntryPoint="set_rigid_body_drag")]
	public static extern unsafe void SetRigidBodyDrag(RigidBodyHandle rbHandle, float linearDrag, float angularDrag);
    ...
    struct UnmanagedData
    {
        ...
        public void load_calls()
        {
			...
			setRigidBodyDrag = NativeLoader.GetFunction(loaded_lib, "set_rigid_body_drag");
		...
		public IntPtr setRigidBodyDrag;
